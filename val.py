...
if __name__ == '__main__':
    # model_path = r'runs\train\yolo11-687-hsfpn+mona1+AYHead\weights\best.pt'
    
    model_path = r'runs\train\yolo11-704-YOLO-AD-Refine\weights\best.pt'
    model = YOLO(model_path) # 选择训练好的权重路径
    result = model.val(data=r'F:\work\paper\dataset\apid.v2i.yolov8\data.yaml',
